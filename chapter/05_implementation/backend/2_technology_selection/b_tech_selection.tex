...
\resizebox{\textwidth}{!}{%
\begin{tabular}{|>{\raggedright\arraybackslash}p{2.5cm}|>{\raggedright\arraybackslash}p{1cm}|>{\raggedright\arraybackslash}p{4cm}|p{3cm}|>{\raggedright\arraybackslash}p{4cm}|}
\hline
...
\resizebox{\textwidth}{!}{%
\begin{tabular}{|>{\raggedright\arraybackslash}p{2cm}|p{1cm}|p{2.5cm}|p{2cm}|p{2.5cm}|p{2.5cm}|}
\hline
